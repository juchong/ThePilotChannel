...
- Display: `http://<pi-ip>:8000`
- Admin: `http://<pi-ip>:8000/admin`

The container restarts automatically and survives reboots once the Docker service is
enabled on boot.

## Provision the kiosk on the Pi

This sets up the on-screen browser. It installs cage and Chromium, enables the GPU
overlay, configures autologin on tty1, and brings up the Docker stack.
